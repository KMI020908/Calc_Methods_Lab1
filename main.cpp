...
int main()
{
    ...
    readData<double>(lCoefSys1, rCoefSys1, IN_FILE_PATH_2);
    qrMethod<double>(lCoefSys1, rCoefSys1, QR_OUT_FILE_PATH_2);

    readData<double>(lCoefSys3, rCoefSys3, IN_FILE_PATH_3);
    gaussMethod<double>(lCoefSys3, rCoefSys3, G_OUT_FILE_PATH_3);
    readData<double>(lCoefSys1, rCoefSys1, IN_FILE_PATH_3);
    qrMethod<double>(lCoefSys1, rCoefSys1, QR_OUT_FILE_PATH_3);

    readData(lCoefSys4, rCoefSys4, IN_FILE_PATH_4);
    gaussMethod(lCoefSys4, rCoefSys4, G_OUT_FILE_PATH_4);
    readData(lCoefSys1, rCoefSys1, IN_FILE_PATH_4);
    qrMethod(lCoefSys1, rCoefSys1, QR_OUT_FILE_PATH_4);

    readData<double>(lCoefSys5, rCoefSys5, IN_FILE_PATH_5);
    gaussMethod<double>(lCoefSys5, rCoefSys5, G_OUT_FILE_PATH_5);
    readData<double>(lCoefSys1, rCoefSys1, IN_FILE_PATH_5);
    qrMethod<double>(lCoefSys1, rCoefSys1, QR_OUT_FILE_PATH_5);
